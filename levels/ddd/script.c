...
const LevelScript level_ddd_entry[] = {
	...
	AREA(2, ddd_area_2),
		WARP_NODE(0x0A, LEVEL_DDD, 0x01, 0x0B, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, 679, 119, 7172, 0, -180, 0, (10 << 16), bhvWarp),
		OBJECT(MODEL_NONE, 4708, 1419, 4991, 0, 0, 0, (175 << 16), bhvPoleGrabbing),
		OBJECT(MODEL_NONE, 659, 1418, 3897, 0, 0, 0, (64 << 16), bhvPoleGrabbing),
		OBJECT(MODEL_NONE, 664, 905, 3332, 0, 0, 0, (16 << 16), bhvPoleGrabbing),
		OBJECT(MODEL_NONE, -1219, 2049, -432, 0, 0, 0, (78 << 16), bhvPoleGrabbing),
	...
	AREA(1, ddd_area_1),
		...
		OBJECT(MODEL_NONE, -1270, 0, 3673, 0, 0, 0, (11 << 16), bhvWarp),
